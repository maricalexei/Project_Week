...
<html lang="en">
  <head>
    ...
    <title>CS:GO Wiki | Gamemodes | Deathmatch</title>
  </head>
  <body>
      <!-- This is the Navbar -->
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <li><a class="dropdown-item" href="bom.php">Bom defuse</a></li>
            <li><a class="dropdown-item" href="deathmatch.php">Deathmatch</a></li>
            <li><a class="dropdown-item" href="hostage.php">Hostage Situation</a></li>
            <li><a class="dropdown-item" href="wingman.php">Wingman</a></li>
          </ul>
          <li class="nav-item dropdown">
          <a class="nav-link active dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Maps
